...
__main	
        ...
        mov r0, #0x00000038  					;; Enable clock sur GPIO D et F et E où sont branchés les leds (0x38 == 0b111000)
		; ;;														 									      (GPIO::FEDCBA)
        str r0, [r6]
...
ReadState
;;Tant que pas d'action correcte reste allumé
		ldr r10,[r8]							
		CMP r10,#0x01
		BNE ReadState
